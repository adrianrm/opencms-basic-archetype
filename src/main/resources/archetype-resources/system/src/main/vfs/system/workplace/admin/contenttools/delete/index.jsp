...
<tr>
	...
	<td colspan="2" class="maxwidth"><%= wp.buildSelectProperty("name=${symbol_escape}"" + CmsPropertyDelete.PARAM_PROPERTYNAME + "${symbol_escape}" size=${symbol_escape}"1${symbol_escape}"") %></td>
</tr>
</table>
