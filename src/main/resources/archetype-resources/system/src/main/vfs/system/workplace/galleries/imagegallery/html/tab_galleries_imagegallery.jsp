...
#set( $symbol_escape = '\' )
	<div id="galleries">
		<!-- displayed when button "show galleries" pressed -->
		...
		<div id="galleryitems">
			...
			<!-- the content is set/unset wby "onmouseover"(showItemInfo/hideItemInfo) and "onclick"(markItem) -->
			<div id="galleryiteminfo">
				<table cellspacing="0" cellpadding="0" border="0">
					...
					<tr>
						...
						<td id="galleryitemdc" style="width: 26%;"></td>
					</tr>
					<tr>
						<td>
							<%= wp.key(Messages.GUI_GALLERY_ITEMDETAIL_TYPE_0) %>
						</td>
						<td id="galleryitemtype">&nbsp;</td>
						<td>
			...
			<!-- Extract to gallerydetailinfo.jsp -->
		</div>
	</div>