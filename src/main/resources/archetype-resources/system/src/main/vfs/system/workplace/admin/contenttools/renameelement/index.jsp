...
<tr>
	...
	<td colspan="2" class="maxwidth"><%= wp.buildSelectTemplates("name=${symbol_escape}"" + wp.PARAM_TEMPLATE + "${symbol_escape}" size=${symbol_escape}"1${symbol_escape}"") %></td>
</tr>
<tr>
	<td style="white-space: nowrap;" unselectable="on"><%= wp.key(org.opencms.workplace.tools.content.Messages.GUI_INPUT_LANG_0) %></td>
	<td colspan="2" class="maxwidth"><%= wp.buildSelectLocales("name=${symbol_escape}"" + wp.PARAM_LOCALE + "${symbol_escape}" size=${symbol_escape}"1${symbol_escape}"") %></td>
</tr>
<tr>
