...
function setList() {
   ...
   if (document.forms['main'].result.value == '0') {
     ...
     html += "<td valign='middle'><span style='color: ${symbol_pound}000099; font-weight: bold;'>";
     html += txt;
...
<%= wp.dialogButtonsOkCancel("id='ok-button' onclick=${symbol_escape}"this.disabled=true; document.forms['main'].submit(); ${symbol_escape}" disabled", null) %>
</form>
...
<%= wp.dialogBlockEnd() %>
<%= wp.buildConfirmation() %>
<%= wp.dialogButtonsOkCancel("id='ok-button' onclick=${symbol_escape}"this.disabled=true; document.forms['main'].submit(); ${symbol_escape}"", null) %>
</form>
