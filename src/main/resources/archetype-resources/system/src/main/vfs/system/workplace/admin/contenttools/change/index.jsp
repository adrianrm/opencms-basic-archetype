...
<tr>
	...
	<td colspan="2" class="maxwidth"><input name="<%= CmsPropertyChange.PARAM_RECURSIVE %>" type="checkbox" value="true"<% if ("true".equals(wp.getParamRecursive())) { out.print("checked=${symbol_escape}"checked${symbol_escape}""); } %>></td>    
</tr>
<tr>
	<td style="white-space: nowrap;" unselectable="on"><%= wp.key(org.opencms.workplace.tools.content.Messages.GUI_INPUT_PROPERTY_0)%></td>
	<td colspan="2" class="maxwidth"><%= wp.buildSelectProperty("name=${symbol_escape}"" + CmsPropertyChange.PARAM_PROPERTYNAME + "${symbol_escape}" size=${symbol_escape}"1${symbol_escape}"") %></td>
</tr>
<tr>
