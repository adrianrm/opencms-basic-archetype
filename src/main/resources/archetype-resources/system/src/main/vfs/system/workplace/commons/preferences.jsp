...
<%= wp.bodyStart("dialog", "onunload=${symbol_escape}"top.closeTreeWin();${symbol_escape}"") %>
<%= wp.dialogStart() %>

<form name="main" action="<%= wp.getDialogUri() %>" method="post" class="nomargin" onsubmit="return submitAction('<%= wp.DIALOG_OK %>', null, 'main');">
<%= wp.paramsAsHidden() %><input type="hidden" name="<%= wp.PARAM_FRAMENAME %>" value="">
<%= wp.dialogTabContentStart(wp.getParamTitle(), "id=${symbol_escape}"tabcontent${symbol_escape}"") %>

<%
switch (wp.getActiveTab()) {
case 1:
	// ${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} workplace settings
	%>
		<%= wp.dialogBlockStart(wp.key(Messages.GUI_PREF_SETTINGS_STARTUP_0)) %>
		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_LABEL_LANGUAGE_0) %></td><td><%= wp.buildSelectLanguage("name=${symbol_escape}"" + wp.PARAM_WORKPLACE_LANGUAGE + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
			<td>&nbsp;</td>
			<td style="white-space: nowrap;width:100px;"><%= wp.key(Messages.GUI_PREF_STARTUP_SITE_0) %></td><td><%= wp.buildSelectSite("name=${symbol_escape}"" + wp.PARAM_WORKPLACE_SITE + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_STARTUP_PROJECT_0) %></td><td><%= wp.buildSelectProject("name=${symbol_escape}"" + wp.PARAM_WORKPLACE_PROJECT + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_STARTUP_VIEW_0) %></td><td><%= wp.buildSelectView("name=${symbol_escape}"" + wp.PARAM_WORKPLACE_VIEW + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
			<td>&nbsp;</td>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="padding:4px;"><%= wp.buildSelectWorkplaceButtonStyle("name=${symbol_escape}"" + wp.PARAM_WORKPLACE_BUTTONSTYLE + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
				...
				<td style="white-space: nowrap;padding: 4px;">
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td><%= wp.buildSelectUpload("name=${symbol_escape}"" + wp.PARAM_WORKPLACE_UPLOADVARIANT + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<td style="white-space: nowrap;padding:4px;"><%= wp.key(Messages.GUI_PREF_REPORT_TYPE_0) %></td><td style="padding:4px;"><%= wp.buildSelectReportType("name=${symbol_escape}"" + wp.PARAM_WORKPLACE_REPORTTYPE + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
				<td style="padding:4px;">&nbsp;</td>
...
break;
case 2:
	// ${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} explorer display settings
	%>	
		...
		<tr>
			...
			<td><%= wp.buildSelectExplorerButtonStyle("name=${symbol_escape}"" + CmsPreferences.PARAM_EXPLORER_BUTTONSTYLE + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
		</tr>
		<tr>
			<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_FILES_PER_PAGE_0) %></td>
			<td><%= wp.buildSelectExplorerFileEntries("name=${symbol_escape}"" + CmsPreferences.PARAM_EXPLORER_FILEENTRIES + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
		</tr>
		<tr>
			<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_SEARCH_RESULT_0) %></td>
			<td><%= wp.buildSelectWorkplaceSearchResult("name=${symbol_escape}"" + CmsPreferences.PARAM_EXPLORER_SEARCH_RESULT + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
		</tr>
		</table>
		<%= wp.dialogBlockEnd() %>
		<%= wp.dialogSpacer() %>
...
break;
case 3:
	// ${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} dialogs settings
	%>
		<%= wp.dialogBlockStart(wp.key(Messages.GUI_PREF_SETTINGS_DEFAULT_0)) %>
		<table border="0" cellpadding="4" cellspacing="0">
			<tr>
				<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_DIALOG_COPY_FILE_0) %></td><td><%= wp.buildSelectCopyFileMode("name=${symbol_escape}"" + wp.PARAM_DIALOGS_COPYFILEMODE + "${symbol_escape}" style=${symbol_escape}"width: 250px;${symbol_escape}"") %></td>
				<td style="width: 40px;">&nbsp;</td>
			...
			<tr>
				<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_DIALOG_COPY_FOLDER_0) %></td><td colspan="3"><%= wp.buildSelectCopyFolderMode("name=${symbol_escape}"" + wp.PARAM_DIALOGS_COPYFOLDERMODE + "${symbol_escape}" style=${symbol_escape}"width: 250px;${symbol_escape}"") %></td>
			</tr>
			<tr>
				<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_DIALOG_DELETE_FILE_0) %></td><td colspan="3"><%= wp.buildSelectDeleteFileMode("name=${symbol_escape}"" + wp.PARAM_DIALOGS_DELETEFILEMODE + "${symbol_escape}" style=${symbol_escape}"width: 250px;${symbol_escape}"") %></td>
			</tr>
			<tr>
				<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_DIALOG_DIRECT_PUBLISH_0) %></td><td colspan="3"><%= wp.buildSelectPublishSiblings("name=${symbol_escape}"" + wp.PARAM_DIALOGS_PUBLISHFILEMODE + "${symbol_escape}" style=${symbol_escape}"width: 250px;${symbol_escape}"") %></td>
			</tr>
		</table>			
		<%= wp.dialogBlockEnd() %>
		<%= wp.dialogSpacer() %>
...
break;
case 4:
	// ${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} editor settings
	%>
		<%= wp.dialogBlockStart(wp.key(Messages.GUI_PREF_SETTINGS_GENERAL_0)) %>
		<table border="0" cellpadding="4" cellspacing="0">
		<tr>
			<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_BUTTON_STYLE_EDITOR_0) %></td>
			<td><%= wp.buildSelectEditorButtonStyle("name=${symbol_escape}"" + wp.PARAM_EDITOR_BUTTONSTYLE + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
		</tr>
		<tr>
			<td style="white-space: nowrap;"><%= wp.key(Messages.GUI_PREF_BUTTON_STYLE_DIRECT_EDIT_0) %></td>
			<td><%= wp.buildSelectDirectEditButtonStyle("name=${symbol_escape}"" + wp.PARAM_DIRECTEDIT_BUTTONSTYLE + "${symbol_escape}" style=${symbol_escape}"width: 200px;${symbol_escape}"") %></td>
		</tr>
		</table>
		<%= wp.dialogBlockEnd() %>
		<%= wp.dialogSpacer() %>
		...
		<table border="0" cellpadding="4" cellspacing="0">
		<%= wp.buildSelectPreferredEditors("style=${symbol_escape}"width: 200px;${symbol_escape}"") %>
		</table>
		<%= wp.dialogBlockEnd() %>
	<%
break;
case 5: 
	// ${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} start galleries settings
  	%>
	<%= wp.dialogBlockStart(wp.key(Messages.GUI_PREF_SETTINGS_STARTUP_0)) %> 
	<table border="0" cellpadding="4" cellspacing="0">
	<%= wp.buildSelectStartGalleries("style=${symbol_escape}"width: 400px;${symbol_escape}"") %>
	</table>
	<%= wp.dialogBlockEnd() %>
	<%
break;
case 6:
	// ${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound} user data settings
	%>
		<script type="text/javascript">
		<!--
