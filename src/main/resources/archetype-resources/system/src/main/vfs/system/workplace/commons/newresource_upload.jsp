...
colors.put("bgColor", "${symbol_pound}C0C0C0");
colors.put("outerBorderRightBottom", "${symbol_pound}333333");
colors.put("outerBorderLeftTop", "${symbol_pound}C0C0C0");
colors.put("innerBorderRightBottom", "${symbol_pound}777777");
colors.put("innerBorderLeftTop", "${symbol_pound}F0F0F0");
colors.put("colorText", "${symbol_pound}000000");
colors.put("progessBar", "${symbol_pound}E10050");
colors.put("bgHeadline", "${symbol_pound}000066");
colors.put("colorHeadline", "${symbol_pound}FFFFFF");
...
<%= wp.dialogButtonsNextCancel("id=${symbol_escape}"nextButton${symbol_escape}"", null) %>
...
<%= wp.dialogButtonsNextCancel("id=${symbol_escape}"nextButton${symbol_escape}" disabled=${symbol_escape}"disabled${symbol_escape}"", null) %>
