...
The quotation mark  character (") is been substituted by the correspondent Unicode format (${symbol_escape}u201C for left double quotation mark and
${symbol_escape}u201D for right double quotation mark) to avoid issues in some circumstances (e.g.: messages involved in JavaScript). 

The apostrophe character (') is been substituted by the correspondent Unicode format ${symbol_escape}u2019 to avoid issues in some circumstances (e.g.: messages in table 
heading). 
