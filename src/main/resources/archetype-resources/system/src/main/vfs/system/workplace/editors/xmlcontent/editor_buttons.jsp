...
if (options.showElement("option.element.language", displayOptions) && wp.showElementLanguageSelector()) {
	...
	out.println("<td>" + wp.buildSelectElementLanguage("name=${symbol_escape}"" + CmsEditor.PARAM_ELEMENTLANGUAGE + "${symbol_escape}" width=${symbol_escape}"150${symbol_escape}" onchange=${symbol_escape}"changeElementLanguage();${symbol_escape}"") + "</td>");
