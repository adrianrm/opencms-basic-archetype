...
<%= wp.dialogButtonsOkCancel("disabled=${symbol_escape}"disabled${symbol_escape}"", "onclick=${symbol_escape}"location.href='" + wp.getDialogUri() + "?" + wp.paramsAsRequest() + "';${symbol_escape}"") %>
</form>
