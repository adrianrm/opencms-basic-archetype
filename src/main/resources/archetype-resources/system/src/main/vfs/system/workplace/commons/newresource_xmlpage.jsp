...
<tr>
	...
	<td class="maxwidth"><%= wp.buildSelectTemplates("name=${symbol_escape}"" + wp.PARAM_TEMPLATE + "${symbol_escape}" class=${symbol_escape}"maxwidth noborder${symbol_escape}"") %></td>
</tr> 
<tr>
	<td style="white-space: nowrap;" unselectable="on"><%= wp.key(Messages.GUI_SELECT_DEFAULTBODY_0) %></td>
	<td class="maxwidth"><%= wp.buildSelectBodyFile("name=${symbol_escape}"" + wp.PARAM_BODYFILE + "${symbol_escape}" class=${symbol_escape}"maxwidth noborder${symbol_escape}"") %></td>
</tr>
<tr>
	<td>&nbsp;</td>
