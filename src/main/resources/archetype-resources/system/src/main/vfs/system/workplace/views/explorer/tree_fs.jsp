...
%><%
	...
	if (wp.showSiteSelector()) {
		frameRows = "24,*,0";
		frameSiteSelector = "<frame name=${symbol_escape}"tree_siteselector${symbol_escape}" src=${symbol_escape}"tree_siteselector.jsp?" + CmsTree.PARAM_RESOURCE + "=/" + params.toString() + "${symbol_escape}" scrolling=${symbol_escape}"no${symbol_escape}">${symbol_escape}n${symbol_escape}t";
	}
...
<script language="javascript" type="text/javascript" src="${symbol_dollar}{param.integrator}"></script>
<% } %>
