...
<!--
	...
	table.chartable {
		...
		border: 1px solid ${symbol_pound}000000;
		margin: 0;
		padding: 0;
		empty-cells: show;
	}
	...
	td.charover {
		...
		text-align: center;
		padding: 4px;
		background-color: ${symbol_pound}E0E0E0;
	}
...
<%= wp.dialogContentEnd() %>
<%= wp.dialogButtonsClose("onclick=${symbol_escape}"window.close();${symbol_escape}"") %>
