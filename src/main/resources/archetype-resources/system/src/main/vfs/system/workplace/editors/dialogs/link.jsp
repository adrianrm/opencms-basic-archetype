...
String.prototype.trim = function() {
	...
	return this.replace(/^${symbol_escape}s*(${symbol_escape}b.*${symbol_escape}b|)${symbol_escape}s*${symbol_dollar}/, "${symbol_dollar}1");
}
...
function checkUrl(strValue) {
	var objRegExp  = /(^[a-z]([a-z_]*)[.]([a-z0-9${symbol_escape}-]*)[.]([a-z_${symbol_escape}.]*)([${symbol_escape}/]*)([a-z_${symbol_escape}/${symbol_escape}.]*)${symbol_dollar})/i;
...
function checkLinkUrl() {
	...
	var pattern=/^([a-zA-Z0-9_.-])+@([a-zA-Z0-9_.-])+${symbol_escape}.([a-zA-Z])+([a-zA-Z])+/;
...
<%= wp.bodyStart("dialog", " onLoad=${symbol_escape}"init();${symbol_escape}" onunload=${symbol_escape}"closeTreeWin();${symbol_escape}"") %>
