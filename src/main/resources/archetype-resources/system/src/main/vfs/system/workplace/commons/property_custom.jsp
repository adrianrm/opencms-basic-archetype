...
<%= wp.dialogButtonsOkCancelAdvanced(null, null, "value=${symbol_escape}""+wp.key(Messages.GUI_PROPERTY_ADVANCED_0)+"${symbol_escape}" onclick=${symbol_escape}"submitAdvanced();${symbol_escape}"") %>
</form>
