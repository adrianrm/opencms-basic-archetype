...
<% }  %>
<%= wp.getSiteSelector("name=${symbol_escape}"treesite${symbol_escape}" onchange=${symbol_escape}"changeSite();${symbol_escape}" style=${symbol_escape}"width:250px;${symbol_escape}"") %>
</form>
</td>
