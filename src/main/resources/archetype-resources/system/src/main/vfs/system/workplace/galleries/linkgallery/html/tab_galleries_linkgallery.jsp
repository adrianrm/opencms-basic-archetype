...
<div id="galleries">
	...
	<div id="galleryitems">
		<div id="gallerybuttons">
			<button type="button" id="gallerynewlinkbutton" disabled="disabled" onclick="${symbol_dollar}('${symbol_pound}gallerynewlink').click();">
				<div> <%= wp.key(Messages.GUI_LINKGALLERY_BUTTON_NEWLINK_0) %> </div>
			</button><a href="${symbol_pound}" class="thickbox" id="gallerynewlink"></a>
