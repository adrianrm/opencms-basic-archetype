...
<td style="vertical-align: top;">
	<a href="${symbol_pound}" onclick="javascript:buttonAction(6);" class="button" title="<%= wp.key("GUI_EDITOR_BUTTON_SYNTAXHIGHLIGHT_0") %>">
...
<td style="vertical-align: top;">
	<a href="${symbol_pound}" onclick="javascript:buttonAction(7);" class="button" title="<%= wp.key("GUI_EDITOR_BUTTON_VISIBLETABS_0") %>">
