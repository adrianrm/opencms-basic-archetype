...
<body class="buttons-head" unselectable="on"<%= wp.isReloadRequired()?" onload=${symbol_escape}"loadBody();${symbol_escape}"":"" %>>
...
<div>
<%= wp.getProjectSelect("name=${symbol_escape}"wpProject${symbol_escape}" onchange=${symbol_escape}"document.forms.wpProjectSelect.submit()${symbol_escape}"", "style=${symbol_escape}"width:150px${symbol_escape}"") %>
...
<div>
<%= wp.getSiteSelect("name=${symbol_escape}"wpSite${symbol_escape}" style=${symbol_escape}"width:150px${symbol_escape}" onchange=${symbol_escape}"document.forms.wpSiteSelect.submit()${symbol_escape}"") %>
<input type="hidden" name="<%= CmsFrameset.PARAM_WP_FRAME %>" value="head">
</div>
</form></td>
...
<div>
<%= wp.getViewSelect("name=${symbol_escape}"wpView${symbol_escape}" style=${symbol_escape}"width:150px${symbol_escape}" onchange=${symbol_escape}"document.forms.wpViewSelect.submit()${symbol_escape}"") %>
<input type="hidden" name="<%= CmsFrameset.PARAM_WP_FRAME %>" value="head">
</div>
</form></td>
