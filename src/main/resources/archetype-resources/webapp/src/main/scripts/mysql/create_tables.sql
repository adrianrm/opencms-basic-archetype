...
CREATE TABLE IF NOT EXISTS CMS_USERDATA (
    USER_ID VARCHAR(36) BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_HISTORY_PRINCIPALS (
...
CREATE TABLE IF NOT EXISTS CMS_GROUPUSERS (
    GROUP_ID VARCHAR(36) BINARY NOT NULL,
    USER_ID VARCHAR(36) BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_HISTORY_PROJECTS (
    PROJECT_ID VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_PROJECTRESOURCES (
    PROJECT_ID VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_HISTORY_PROJECTRESOURCES (
    PUBLISH_TAG INT NOT NULL,
    PROJECT_ID VARCHAR(36) NOT NULL,
    RESOURCE_PATH TEXT BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_OFFLINE_PROPERTYDEF (
...
CREATE TABLE IF NOT EXISTS CMS_ONLINE_PROPERTYDEF (
    PROPERTYDEF_ID VARCHAR(36) BINARY NOT NULL, 
    PROPERTYDEF_NAME VARCHAR(128) BINARY NOT NULL,
    PROPERTYDEF_TYPE INT NOT NULL,
    PRIMARY KEY (PROPERTYDEF_ID), 
...
CREATE TABLE IF NOT EXISTS CMS_HISTORY_PROPERTYDEF (
    PROPERTYDEF_ID VARCHAR(36) BINARY NOT NULL, 
    PROPERTYDEF_NAME VARCHAR(128) BINARY NOT NULL,
    PROPERTYDEF_TYPE INT NOT NULL,
    PRIMARY KEY (PROPERTYDEF_ID), 
...
CREATE TABLE IF NOT EXISTS CMS_OFFLINE_PROPERTIES (
...
CREATE TABLE IF NOT EXISTS CMS_ONLINE_PROPERTIES (
    PROPERTY_ID VARCHAR(36) BINARY NOT NULL,
    PROPERTYDEF_ID VARCHAR(36) BINARY NOT NULL,
    PROPERTY_MAPPING_ID VARCHAR(36) BINARY NOT NULL,
    PROPERTY_MAPPING_TYPE INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_HISTORY_PROPERTIES (
...
CREATE TABLE IF NOT EXISTS CMS_ONLINE_ACCESSCONTROL (
...
CREATE TABLE IF NOT EXISTS CMS_OFFLINE_ACCESSCONTROL (
    RESOURCE_ID VARCHAR(36) BINARY NOT NULL,
    PRINCIPAL_ID VARCHAR(36) BINARY NOT NULL,
    ACCESS_ALLOWED INT,
    ACCESS_DENIED INT,
...
CREATE TABLE IF NOT EXISTS CMS_PUBLISH_HISTORY (
...
CREATE TABLE IF NOT EXISTS CMS_RESOURCE_LOCKS (
  RESOURCE_PATH TEXT BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_STATICEXPORT_LINKS (
...
CREATE TABLE IF NOT EXISTS CMS_OFFLINE_STRUCTURE (
    STRUCTURE_ID VARCHAR(36) BINARY NOT NULL,
    RESOURCE_ID VARCHAR(36) BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_ONLINE_STRUCTURE (
    STRUCTURE_ID VARCHAR(36) BINARY NOT NULL,
    RESOURCE_ID VARCHAR(36) BINARY NOT NULL,
    PARENT_ID VARCHAR(36) BINARY NOT NULL,
    RESOURCE_PATH TEXT BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_HISTORY_STRUCTURE (
    PUBLISH_TAG INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_OFFLINE_RESOURCES (
    RESOURCE_ID VARCHAR(36) BINARY NOT NULL,
    RESOURCE_TYPE INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_ONLINE_RESOURCES (
    RESOURCE_ID VARCHAR(36) BINARY NOT NULL,
    RESOURCE_TYPE INT NOT NULL,
    RESOURCE_FLAGS INT NOT NULL,
    RESOURCE_STATE    SMALLINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_HISTORY_RESOURCES (
    RESOURCE_ID VARCHAR(36) BINARY NOT NULL,
    RESOURCE_TYPE INT NOT NULL,
    RESOURCE_FLAGS INT NOT NULL,
    RESOURCE_STATE    SMALLINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_OFFLINE_CONTENTS (
    RESOURCE_ID VARCHAR(36) BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_ONLINE_RESOURCE_RELATIONS (
...
CREATE TABLE IF NOT EXISTS CMS_OFFLINE_RESOURCE_RELATIONS (
    RELATION_SOURCE_ID VARCHAR(36) BINARY NOT NULL,
    RELATION_SOURCE_PATH TEXT BINARY NOT NULL,
    RELATION_TARGET_ID VARCHAR(36) BINARY NOT NULL,
    RELATION_TARGET_PATH TEXT BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_USER_PUBLISH_LIST (
	USER_ID VARCHAR(36) BINARY NOT NULL,
	STRUCTURE_ID VARCHAR(36) BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_SUBSCRIPTION_VISIT (
	USER_ID VARCHAR(36) BINARY NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_OFFLINE_URLNAME_MAPPINGS (
	NAME VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_ONLINE_URLNAME_MAPPINGS (
	NAME VARCHAR(255) NOT NULL,
	STRUCTURE_ID VARCHAR(36) NOT NULL,
	STATE INT NOT NULL,
	DATE_CHANGED BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS CMS_REWRITES
  (
