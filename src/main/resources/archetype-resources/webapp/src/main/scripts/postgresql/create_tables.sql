...
DROP INDEX IF EXISTS ONLINE_ACCESSCONTROL_02_IDX;   
...
DROP INDEX IF EXISTS OFFLINE_ACCESSCONTROL_02_IDX;
...
DROP INDEX IF EXISTS CMS_PUBLISH_HISTORY_02_IDX;
...
DROP INDEX IF EXISTS CMS_RESOURCE_LOCKS_01_IDX;
...
DROP INDEX IF EXISTS CMS_HISTORY_STRUCTURE_09_IDX;
...
DROP INDEX IF EXISTS CMS_HISTORY_RESOURCES_07_IDX;
...
DROP INDEX IF EXISTS CMS_LOG_09_IDX;	
...
DROP INDEX IF EXISTS CMS_USERPUBLIST_IDX_01;	
CREATE INDEX CMS_USERPUBLIST_IDX_01 ON CMS_USER_PUBLISH_LIST (USER_ID);
DROP INDEX IF EXISTS CMS_USERPUBLIST_IDX_02;	
...
DROP INDEX IF EXISTS CMS_REWRITES_IDX_01;	
