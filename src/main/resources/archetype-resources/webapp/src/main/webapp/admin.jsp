...
// Insert oder Update Befehl ausf?ren
			...
			if ( "true".equals( execSql ) ) {
				...
				try {
					...
					sqlExecErr = "Befehl konnte nicht ausgef?rt werden." + se;
...
.hr_stil {
	color: ${symbol_pound}FF7F00;
	background-color: ${symbol_pound}FF7F00;
}
-->
</style>
</head>
...
<form method="post" action="${symbol_pound}mailVersand"><input type="hidden"
...
<table width="769" border="0">
	...
	<tr>
		<td width="297"></td>
		<td height="40"><input type="submit" value="SQL-Befehl ausf?ren" /></td>
	</tr>
	<tr>
		<td height="40" colspan="2" align="center">
